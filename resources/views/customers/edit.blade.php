                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control" name="image" value="{{ asset($customer->image) }}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 mb-3">
                                <div class="form-group">
                                    ...
                                    <textarea name="about" id="about" cols="30" rows="10" class="form-control">{{ $customer->about }}</textarea>
                                </div>
                            </div>
                            <div class="col-md-12 mb-3">
